<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">党务政务服务热线平台设计与实现 注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='bumen'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.bumenmingcheng" class="input" type="text" placeholder="部门名称">
			   </div>
			 </div> -->
			<el-form-item label="部门名称" class="input" v-if="tableName=='bumen'">
			  <el-input v-model="ruleForm.bumenmingcheng" autocomplete="off" placeholder="部门名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='bumen'" class="input-group">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='bumen'">
			...
			<el-form-item label="联系号码" class="input" v-if="tableName=='bumen'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='bumen'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='bumen'" class="input-group">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='bumen'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.bumenmingcheng) && `bumen` == this.tableName){
        this.$message.error(`部门名称不能为空`);
        return
      }
      if((!this.ruleForm.fuzeren) && `bumen` == this.tableName){
      ...
      if(`bumen` == this.tableName && this.ruleForm.lianxihaoma&&(!this.$validate.isMobile(this.ruleForm.lianxihaoma))){
        this.$message.error(`联系号码应输入手机格式`);
        return
      }
      if(`bumen` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      this.$http({
